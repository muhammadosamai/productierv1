import type { FormFieldConfig, EntityType } from '@/types/formConfig'
...
const storyFields: FormFieldConfig[] = [
  ...
  { key: 'priority', label: 'Priority', type: 'select', required: true, visible: true, isBuiltIn: true, order: 3, options: ['critical', 'high', 'medium', 'low'] },
...
const issueFields: FormFieldConfig[] = [
  ...
  { key: 'severity', label: 'Severity', type: 'select', required: true, visible: true, isBuiltIn: true, order: 8, options: ['critical', 'major', 'minor', 'trivial'] },
  { key: 'priority', label: 'Priority', type: 'select', required: true, visible: true, isBuiltIn: true, order: 9, options: ['critical', 'high', 'medium', 'low'] },
