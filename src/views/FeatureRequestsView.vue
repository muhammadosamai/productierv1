...
onMounted(() => {
  store.fetchAll(productStore.activeProductScopeForApi, 'votes')
...
async function handleUpvote(id: string, e: Event) {
  ...
  await store.fetchAll(productStore.activeProductScopeForApi, 'votes')
}
        ...
        >
          ...
          <div class="flex-1 p-4 flex flex-col min-w-0">
            ...
            <div class="flex items-start gap-2 mb-1.5">
              <FavoriteStar entity-type="feature_request" :entity-id="item.id" :product-id="productStore.activeProductScopeForApi" />
